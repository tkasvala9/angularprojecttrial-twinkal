...
export class AppComponent {
  ...
  additemtocart(product:any){
    ...
    this.c++;
    this.totalq+=Number(product.quntityavailable);
    this.bill+= Number(product.quntityavailable) *Number(product.price);
  }
